...
export const middleware = router.named({
  verifyStripeWebhook: () => import('#marketing/middleware/verify_stripe_webhook_middleware'),
  verifyProfile: () => import('#auth/middleware/verify_profile_middleware'),
  guest: () => import('#auth/middleware/guest_middleware'),
  auth: () => import('#auth/middleware/auth_middleware'),
  role: () => import('#auth/middleware/role_middleware'),
})
